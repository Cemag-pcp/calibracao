            ...
            $.ajax({
                ...
                success: function (lista_historico) { // Adicione o parâmetro 'data' aqui
                    ...
                    lista_historico.forEach(function (item) {
                        ...
                        row.append($('<td style="display:None"></td>').text(item[0])); // ID
                        row.append($('<td></td>').text(item[5])); // N° Calibração
                        row.append($('<td></td>').text(item[1])); // Data
                        row.append($('<td></td>').text(item[3])); // EMA
                        row.append($('<td></td>').text(item[4])); // EMT
